...
<body>
        <header class="h-16 w-screen flex justify-between items-center" style="background-color: #2c3e50;">
        <div id="logo">
        <img src="../public/modern_circular_icon_for_SleepSense_with_black__gray__and_white_colors-removebg-preview.png" width="40" height="40" id="hero-img" alt="" class="bg-white rounded-full">
            <a> SLEEPSENSE</a>
        </div>
        <nav id="main-nav">
